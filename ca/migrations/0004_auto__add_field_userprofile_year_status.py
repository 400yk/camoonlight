...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.year_status'
        db.add_column(u'ca_userprofile', 'year_status',
                      self.gf('django.db.models.fields.CharField')(default='SR', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.year_status'
        db.delete_column(u'ca_userprofile', 'year_status')
