...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'ca_articles')

        # Adding model 'Article'
        db.create_table(u'ca_article', (
        ...
        db.send_create_signal(u'ca', ['Article'])


    def backwards(self, orm):
        # Adding model 'Articles'
        db.create_table(u'ca_articles', (
            ('body', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('upload_date', self.gf('django.db.models.fields.DateField')()),
            ('title', self.gf('django.db.models.fields.TextField')()),
            ('author', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ...
        db.send_create_signal(u'ca', ['Articles'])

        # Deleting model 'Article'
        db.delete_table(u'ca_article')
